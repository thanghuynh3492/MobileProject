...
namespace PhoneApp7
{
    public partial class WordGameHome : PhoneApplicationPage
    {
        ...
        private void btclothes_Tap(object sender, System.Windows.Input.GestureEventArgs e)
        {
            ...
            NavigationService.Navigate(new Uri(string.Format("/WordGame.xaml?id={0}", 2), UriKind.Relative));
        }

        private void btAlphabel_Tap(object sender, System.Windows.Input.GestureEventArgs e)
        {
            DataMainPage page = (DataMainPage)lstMainPage.SelectedItem;
            NavigationService.Navigate(new Uri(string.Format("/WordGame.xaml?id={0}", 5), UriKind.Relative));
        }

        private void btAnimal_Tap(object sender, System.Windows.Input.GestureEventArgs e)
        {
            DataMainPage page = (DataMainPage)lstMainPage.SelectedItem;
            NavigationService.Navigate(new Uri(string.Format("/WordGame.xaml?id={0}", 7), UriKind.Relative));
        }

        private void btNumber_Tap(object sender, System.Windows.Input.GestureEventArgs e)
        {
            DataMainPage page = (DataMainPage)lstMainPage.SelectedItem;
            NavigationService.Navigate(new Uri(string.Format("/WordGame.xaml?id={0}", 6), UriKind.Relative));
        }

        private void btschool_Tap(object sender, System.Windows.Input.GestureEventArgs e)
        {
            DataMainPage page = (DataMainPage)lstMainPage.SelectedItem;
            NavigationService.Navigate(new Uri(string.Format("/WordGame.xaml?id={0}", 8), UriKind.Relative));
        }

        private void btColor_Tap(object sender, System.Windows.Input.GestureEventArgs e)
        {
            DataMainPage page = (DataMainPage)lstMainPage.SelectedItem;
            NavigationService.Navigate(new Uri(string.Format("/WordGame.xaml?id={0}", 1), UriKind.Relative));
        }

        private void btFruit_Tap(object sender, System.Windows.Input.GestureEventArgs e)
        {
            DataMainPage page = (DataMainPage)lstMainPage.SelectedItem;
            NavigationService.Navigate(new Uri(string.Format("/WordGame.xaml?id={0}", 4), UriKind.Relative));
        }

        private void btVegetable_Tap(object sender, System.Windows.Input.GestureEventArgs e)
        {
            DataMainPage page = (DataMainPage)lstMainPage.SelectedItem;
            NavigationService.Navigate(new Uri(string.Format("/WordGame.xaml?id={0}", 3), UriKind.Relative));
        }
    }
}
